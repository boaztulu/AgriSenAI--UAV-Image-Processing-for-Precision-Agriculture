...
def main(input_dir):
    output_dir = os.path.join(input_dir, 'Noise_output')
...
if __name__ == '__main__':
    # This part will not be executed when the script is imported, but only when run directly
    input_dir = r'C:\path\to\your\directory'  # Replace with your default directory path
    main(input_dir)
